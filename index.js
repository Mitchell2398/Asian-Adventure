...
document.querySelectorAll("nav a.smooth-scroll").forEach((anchor) => {
  anchor.addEventListener("click", function (e) {
    ...
    if (target) {
      // Check if target exists to avoid any issues
...
// This carousel was taken from https://codepen.io/WillyW/pen/wZebow, I adjusted it to fit our needs by trimming it down to 4 cards and adding in our own images and text
...
class CardCarousel extends DraggingEvent {
  ...
  controller(e) {
    ...
    if (this.prevButton && this.nextButton) {
      this.prevButton.addEventListener('click', () => this.handleArrowClick('left'));
      this.nextButton.addEventListener('click', () => this.handleArrowClick('right'));
    }
